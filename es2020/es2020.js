...
// It has a bigint to add, add new formatting to the bigint
/* 3 + 4 + 1n */
...
let pokAndrei = andrei_pokemon?.raichu?.species
let pokWill = andrei_pokemon?.raichu?.species
if (pokAndrei && pokWill) {
    console.log('pokAndrei!', pokAndrei)
    console.log('fight!')
} else {
    console.log('walk away')
}
